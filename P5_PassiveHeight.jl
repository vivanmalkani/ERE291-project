...
writedlm("MaxPassiveHeightalt.csv",PASSIVEHEIGHTMAXREVENUE, ',')

PassiveHeightRevenuePlot = plot(PassiveHeightRange,
PASSIVEHEIGHTMAXREVENUE,
ylabel = "Revenue (USD)",
 xlabel = "Passive Storage Tank Height (meters)",
 label = ["Revenue varying with Storage Height"],
 title="Passive Tank Height Sensitivity",
 lw = 2)

png(PassiveHeightRevenuePlot, "Passive Height Sensitivity")
